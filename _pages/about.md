...
I am an archaeologist investigating sociopolitical organization in the tropical maritime environments of the East African Swahili Coast. Currently, I am a National Science Foundation SBE postdoctoral fellow at the Center for Advanced Spatial Technologies (CAST) at the University of Arkansas, Fayetteville.

I use settlement patterns and ceramic data to theorize about the integrative and autonomous activities of rural commoners, and the ways that bottom-up activities by these groups conditioned the emergence of nascent elites. I also use remote sensing and spatial statistics to model and analyze the environments that mediated specific dynamics within Swahili social systems. Currently, I am directing the Zanzibar Urban-Rural Complexity Project (ZURCP) in Zanzibar, Tanzania, to address these questions from the 7th to 19th centuries CE.
